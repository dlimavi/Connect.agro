...
namespace Connect.Agro.Controllers
{
    ...
    public class SectorController : ControllerBase
    {
        ...
        public async Task<IActionResult> ListSectors()
        {
            ...
            var Sectors = await SectorService.GetSectorListAsync();
        ...
        {
            var SectorService = new SectorService();
            var response = await SectorService.GetSectorByIdAsync(id);
        ...
        {
            var SectorService = new SectorService();
            await SectorService.CreateSectorAsync(createSectorRequest);
        ...
        {
            var SectorService = new SectorService();
            var updatedSector = await SectorService.UpdateSectorAsync(Sector);
        ...
        {
            var SectorService = new SectorService();
            var deleted = await SectorService.DeleteSectorAsync(SectorId);
