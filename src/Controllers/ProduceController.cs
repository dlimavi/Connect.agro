...
public class ProduceController : ControllerBase
{
    ...
    public async Task<IActionResult> ListProduces()
    {
        ...
        var Produces = await ProduceService.GetProduceList();
    ...
    {
        var ProduceService = new ProduceService();
        var response = await ProduceService.GetProduceById(id);
    ...
    {
        var ProduceService = new ProduceService();
        var createdProduceId = await ProduceService.CreateProduce(Produce);
    ...
    {
        var ProduceService = new ProduceService();
        var updatedProduce = await ProduceService.UpdateProduce(Produce);
    ...
    {
        var ProduceService = new ProduceService();
        var deleted = await ProduceService.DeleteProduce(ProduceId);
