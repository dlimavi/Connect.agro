...
public class SupplyController : ControllerBase
{
    ...
    public async Task<IActionResult> ListSupplys()
    {
        ...
        var Supplys = await SupplyService.GetSupplyList();
    ...
    {
        var SupplyService = new SupplyService();
        var response = await SupplyService.GetSupplyById(id);
    ...
    {
        var SupplyService = new SupplyService();
        var createdSupplyId = await SupplyService.CreateSupply(Supply);
    ...
    {
        var SupplyService = new SupplyService();
        var updatedSupply = await SupplyService.UpdateSupply(Supply);
    ...
    {
        var SupplyService = new SupplyService();
        var deleted = await SupplyService.DeleteSupply(SupplyId);
